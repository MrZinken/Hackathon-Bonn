...
input_dir = Path("/home/glasenapp/Schreibtisch/input")  # ändern falls nötig
    ...
    for tif_path in current_batch:
        ...
        for y in range(0, tile_size * 5, tile_size):
            for x in range(0, tile_size * 5, tile_size):
                ...
                tile.save(group_folder / out_name, "JPEG", quality=95)
                count += 1

    group_index += 1

print("✅ Fertig! Alle Bilder wurden gesliced und gespeichert.")
